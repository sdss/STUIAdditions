...
#         self.fooTimer.start(self.wait, foo) # schedule self again
        ...
        self.SnExp1, self.nExp0=self.sopModel.doApogeeMangaSequence_ditherSeq[0:2]
        try:
        ...
        self.sopModel.doApogeeMangaSequence_ditherSeq.addCallback(self.doScience_nExp, callNow=True)
