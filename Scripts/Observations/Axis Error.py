...
class ScriptClass(object):
    def __init__(self, sr):
        ...
        # "axisError:RA"
        self.ppWdg.setYLimits(-0.3, 0.3, subplotInd=0)
        ...
        # "axisError:Dec"
        self.ppWdg.setYLimits(-0.3, 0.3, subplotInd=1)
        ...
        self.ppWdg.plotKeyVar(label="axePos:alt", subplotInd=2,
                              keyVar=self.tccModel.axePos, keyInd=1,
                              color="green")
