...
2020-02-13 DG   Updates for Python 3
"""
import RO.Wdg
import tkinter
import TUI.Models
...
class ScriptClass(object):
    ...
    def run(self, sr, sel=0):
        ...
        # destination altDes from self.altWdg
        self.altDes = self.altWdg.getNum()
        ...
        if self.ifBrakesOn():
            ...
            os.popen('say {} '.format(mes))  # say mes
        ...
        # alt maximum position error (deg)
        # from init section -  self.MaxPosErr = 0.01
        ...
        #  if owner is None,  "mcp sem_take" (new sem_steal) will take sem to
        #  mcp
            ...
            if direct == "Down":
                if nextAlt < (self.altDes - 0.5):
                    ...
                    break
                        ...
                        self.altDes + (self.alt - self.altDes) * 0.2) and abs(
                        vel) >= abs(velold):
                    self.prnMsg(ssPos)
