...
# Center of loop  widget
        ...
        self.centerWdg = RO.Wdg.IntEntry(master =wdgR1a, defValue = wcenter,
             minValue = -500, maxValue = 800, helpText = "Center of focus loop",)
...
# Number of points
        ...
        self.npWdg = RO.Wdg.IntEntry(master =wdgR1b, defValue = np,
             minValue =3, maxValue =20, helpText ="Number of focus positions to mesure",)
...
# Step widget
        ...
        self.stepWdg = RO.Wdg.IntEntry(master =wdgR1c, defValue = st,
             minValue =10, maxValue =100, helpText = "Step for focus changes",)
...
# Guider integration time
        ...
        self.gexpWdg = RO.Wdg.IntEntry(master=wdgR2a, defValue = gexp,
             minValue =2, maxValue =30, helpText = "gcamera integration time",)
...
#  
        ...
        self.gnWdg = RO.Wdg.IntEntry(master=wdgR2b, defValue = gn,
             minValue =1, maxValue =5, helpText = "Number of exposures at the same focus position")
...
# Row 2
    ...
    def run(self, sr):
        ...
        yield sr.waitCmd(actor="tcc",cmdStr="set foc="+str(curFoc), checkFail = False)
